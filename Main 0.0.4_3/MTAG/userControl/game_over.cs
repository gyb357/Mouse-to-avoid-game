...
namespace MTAG
{
    public partial class game_over : UserControl
    {
        ...
        private void Label_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (l == label2)
            {
                label2.Image = Properties.Resources.다시하기p;
            }
            else if (l == label3)
            {
                label3.Image = Properties.Resources.선택화면으로p;
            }
        }
        ...
        private void label3_MouseLeave(object sender, EventArgs e)
        {
            ...
            if (l == label2)
            {
                label2.Image = Properties.Resources.다시하기n;
            }
            else if (l == label3)
            {
                label3.Image = Properties.Resources.선택화면으로n;
            }
        }
    }
}
